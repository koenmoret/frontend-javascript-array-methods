...
// let inventorsBorn16e =  [];
// for(let i=0;i<inventors.length;i++){
//   if(inventors[i].year >= 1500 && inventors[i].year <= 1600){
//     inventorsBorn16e.push(inventors[i]);
//   }
// }
// console.log(inventorsBorn16e);

const inventorsBorn16e = inventors.filter((inventor) => {
...
const inventorsBorn = inventors.map((inventor) => {
...
//     // }
// })
const findEdison = inventors.find((inventor)=> inventor.last === "Edison");
